...
namespace ConsoleApp4
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            /*var variable = "";
            variable = 5;
            Ошибка: невозможно неявно преобразовать int в string.
            var не дает изменить тип переменной, задающийся при
            инициализации. Проблема решается использованием dynamic.
            */
